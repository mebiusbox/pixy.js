...
const bokehUniforms = {
	...
	shaderFocus: { value: 1 },
	focusCoords: { value: new THREE$1.Vector2() },
};
...
const depthShadowReceiveUniforms = {
	mLightViewProjection: { value: new THREE$1.Matrix4() },
	mShadowMatrix: { value: new THREE$1.Matrix4() },
	tDiffuse: { value: null },
	tShadow: { value: null },
};
...
const fakeSunUniforms = {
	sunPos: { value: new THREE$1.Vector2() },
	aspect: { value: 1.0 },
	sunColor: { value: new THREE$1.Color() },
	bgColor: { value: new THREE$1.Color() },
};
