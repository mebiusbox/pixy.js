...
var copyFrag$1 = "vec4 texel = texture2D(tDiffuse, pin.uv);\r\npout.color = texel.rgb;\r\npout.opacity = texel.a;";
...
var gradationLineUniforms = {
  cDirection: { value: new THREE.Vector2(0.0, 1.0) },
  cPowerExponent: { value: 1.0 },
  cOffset: { value: 0.0 }
};

var gradationUniforms = {
  cDirection: { value: new THREE.Vector2(0.0, 1.0) },
  cPowerExponent: { value: 1.0 }
};
...
export { ShaderChunk, ShaderUtils, Shader, ShaderLib, Solar, Ocean, ShadowMesh, GPUParticle, HeightField, ScreenSprite, Composer, Pass, ClearPass, MaskPass, ClearMaskPass, RenderPass, ShaderPass, ScreenPass, CopyPass, EdgePass, SSAARenderPass, TAARenderPass, UnrealBloomPass, SSAOPass, AreaLight, TubeLight, RectLight, FxgenShader, FxgenShaderUtils, any, all, radians, degrees, pow2, gauss, buildKernel, buildGause, createCubeMap, createMesh, createPlaneReflectMatrix, createShadowedLight, clearTextOut, textOut, textOutMatrix4, floatFormat, dumpMatrix4, ViewRGB, ViewAlpha, ViewR, ViewG, ViewB, ViewDecodeRGB, ViewDecodeDepth, ViewDepth };
