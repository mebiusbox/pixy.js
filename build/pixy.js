(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('three/addons/libs/lil-gui.module.min.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', 'three/addons/libs/lil-gui.module.min.js'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.PIXY = {}, global.THREE, global.GUI));
})(this, (function (exports, THREE$1, lilGui_module_min_js) { 'use strict';
	...
	const ambientHemisphereUniforms = {
		groundColor: { value: new THREE__namespace.Color( 0x404040 ) },
		skyDirection: { value: new THREE__namespace.Vector3( 0, 1, 0 ) },
	};

	const ambientUniforms = {
		ambientColor: { value: new THREE__namespace.Color( 0x0 ) },
	};
	...
	const anisotropyUniforms = {
		...
		anisotropyColor: { value: new THREE__namespace.Color() },
	};
	...
	const antiAliasUniforms = {
		tDiffuse: { value: null },
		resolution: { value: new THREE__namespace.Vector2( 1 / 1024, 1 / 512 ) },
	};
	...
	const billboardUniforms = {
		ViewInverse: { value: new THREE__namespace.Matrix4() },
	};
	...
	const castShadowUniforms = {
		lightViewProjectionMatrix: { value: new THREE__namespace.Matrix4() },
	};
	...
	const clippingPlaneUniforms = {
		clippingPlane: { value: new THREE__namespace.Vector4() },
	};
	...
	const colorBalanceUniforms$1 = {
		cColorBalanceColor: { value: new THREE__namespace.Vector3( 0.0, 0.0, 0.0 ) },
	};
	...
	const deferredLightUniforms = {
		...
		viewInverse: { value: new THREE__namespace.Matrix4() },
		viewProjectionInverse: { value: new THREE__namespace.Matrix4() },
		viewPosition: { value: new THREE__namespace.Vector3() },
	...
	const edgeCompositeUniforms = {
		tDiffuse: { value: null },
		tEdge: { value: null },
		edgeColor: { value: new THREE__namespace.Vector3() },
	};
	...
	const edgeExpandUniforms = {
		tDiffuse: { value: null },
		aspect: { value: new THREE__namespace.Vector2() },
		strength: { value: 0.7 },
	};
	...
	const emissiveUniforms = {
		emissiveColor: { value: new THREE__namespace.Color( 0x0 ) },
	};
	...
	const fogUniforms = {
		...
		fogFar: { value: 50.0 },
		fogNear: { value: 1.0 },
		fogColor: { value: new THREE__namespace.Color() },
	};
	...
	const heightFogUniforms = {
		...
		heightFogColor: { value: new THREE__namespace.Color() },
	};
	...
	const innerGlowUniforms = {
		innerGlowColor: { value: new THREE__namespace.Color() },
			...
			value: [
				{
					...
					color: new THREE__namespace.Color( 0xffffff ),
				},
			],
		},
	};
	...
	const lightsSpotUniforms = {
		spotLights: {
			value: [
				{
					position: new THREE__namespace.Vector3( 0, 0, 10 ),
					direction: new THREE__namespace.Vector3( 0, 0, - 1 ),
					color: new THREE__namespace.Color(),
					distance: 10.0,
					decay: 0.0,
	...
	const lineGlowUniforms = {
		lineGlowPlane: { value: new THREE__namespace.Vector4( 0, 1, 0, 0 ) },
		lineGlowColor: { value: new THREE__namespace.Color( 0xffffff ) },
	...
	const luminosityHighPassUniforms = {
		...
		defaultColor: { value: new THREE__namespace.Color( 0x000000 ) },
	...
	const projectionMapUniforms = {
		...
		projectionMapMatrix: { value: new THREE__namespace.Matrix4() },
		projectionMapPos: { value: new THREE__namespace.Vector3() },
		projectionColor: { value: new THREE__namespace.Color() },
	};
	...
	const receiveShadowUniforms = {
		lightViewProjectionMatrix: { value: new THREE__namespace.Matrix4() },
		shadowMatrix: { value: new THREE__namespace.Matrix4() },
	...
	const rimLightUniforms = {
		rimLightColor: { value: new THREE__namespace.Color() },
	...
	const skyDomeUniforms = {
		topColor: { value: new THREE__namespace.Color( 0x0077ff ) },
		bottomColor: { value: new THREE__namespace.Color( 0xffffff ) },
		offset: { value: 33 },
		exponent: { value: 0.6 },
	};
	...
	const skyUniforms = {
		...
		skySunPosition: { value: new THREE__namespace.Vector3() },
	};
	...
	const ssao2BlurUniforms = {
		tAO: { value: null },
		blurParams: { value: new THREE__namespace.Vector4() },
	};
	...
	const ssao2Uniforms = {
		...
		radiusParams: { value: new THREE__namespace.Vector4() },
		biasParams: { value: new THREE__namespace.Vector4() },
		screenParams: { value: new THREE__namespace.Vector4() },
		uvToViewParams: { value: new THREE__namespace.Vector4() },
		focalParams: { value: new THREE__namespace.Vector4() },
		cameraParams: { value: new THREE__namespace.Vector2() },
	};
	...
	const ssaoUniforms = {
		tDiffuse: { value: null },
		tDepth: { value: null },
		size: { value: new THREE__namespace.Vector2( 512, 512 ) },
		cameraNear: { value: 1 },
		cameraFar: { value: 100 },
		onlyAO: { value: 0 },
		aoClamp: { value: 0.5 },
	...
	const velvetUniforms = {
		surfaceColor: { value: new THREE__namespace.Color() },
		fuzzySpecColor: { value: new THREE__namespace.Color() },
		subColor: { value: new THREE__namespace.Color() },
		rollOff: { value: 0.3 },
	...
	const ShaderUtils = {
		...
		GenerateShaderParametersGUI( shader, callback ) {
			...
			const gui = new lilGui_module_min_js.GUI();
			let h;
			let parameters = {};
	...
	class AreaLight {
		...
		constructor() {
			...
			this.color = new THREE__namespace.Color( 0xffffff );
			this.distance = 50.0;
			this.decay = 1.0;
			this.radius = 1.0;
	...
	class TubeLight {
		...
		constructor() {
			...
			this.start = new THREE__namespace.Vector3();
			this.end = new THREE__namespace.Vector3();
			this.color = new THREE__namespace.Color( 0xffffff );
			this.distance = 50.0;
			this.decay = 1.0;
			this.radius = 1.0;
	...
	class RectLight {
		...
		constructor() {
			...
			this.positions = [];
			this.normal = new THREE__namespace.Vector3( 0, 0, 1 );
			this.tangent = new THREE__namespace.Vector3( 1, 0, 0 );
			this.color = new THREE__namespace.Color( 0xffffff );
			this.intensity = 1.0;
			this.width = 1.0;
			this.height = 1.0;
			this.distance = 50.0;
			this.decay = 1.0;
			this.matrix = new THREE__namespace.Matrix4();
			this.numPositions = 4;
	...
	class Shader {
		...
		setParameter( key, value ) {
			...
			if ( key in this.uniforms ) {
				...
				if ( this.uniforms[ key ].value instanceof THREE__namespace.Color ) {

					if ( value instanceof THREE__namespace.Color ) {

						this.uniforms[ key ].value.copy( value );

					} else {

						this.uniforms[ key ].value.copy( new THREE__namespace.Color( value ) );

					}

				} else if (
					this.uniforms[ key ].value instanceof THREE__namespace.Color ||
					this.uniforms[ key ].value instanceof THREE__namespace.Vector2 ||
					this.uniforms[ key ].value instanceof THREE__namespace.Vector3 ||
					this.uniforms[ key ].value instanceof THREE__namespace.Vector4 ||
					this.uniforms[ key ].value instanceof THREE__namespace.Matrix3 ||
					this.uniforms[ key ].value instanceof THREE__namespace.Matrix4
				) {

					this.uniforms[ key ].value.copy( value );

				} else if (
					this.uniforms[ key ].value instanceof THREE__namespace.CubeTexture ||
					this.uniforms[ key ].value instanceof THREE__namespace.Texture
				) {
		...
		setArrayParameter( arrayKey, index, key, value ) {
			...
			if ( arrayKey in this.uniforms ) {
				...
				if ( key in this.uniforms[ arrayKey ].value[ index ] ) {
					...
					if (
						this.uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Color ||
						this.uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Vector2 ||
						this.uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Vector3 ||
						this.uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Vector4 ||
						this.uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Matrix3 ||
						this.uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Matrix4
					) {

						this.uniforms[ arrayKey ].value[ index ][ key ].copy( value );

					} else if (
						this.uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.CubeTexture ||
						this.uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Texture
					) {
		...
		setLightParameter( index, light, camera ) {
			...
			if ( light instanceof THREE__namespace.DirectionalLight ) {
			...
			} else if ( light instanceof THREE__namespace.AmbientLight ) {
				...
				const start = new THREE__namespace.Vector3().copy( light.start );
				start.applyMatrix4( camera.matrixWorldInverse );
				const end = new THREE__namespace.Vector3().copy( light.end );
				...
				for ( let i = 0; i < light.positions.length; ++i ) {
					...
					const p = new THREE__namespace.Vector3().copy( light.positions[ i ] );
					p.applyMatrix4( matrix );
					positions.push( p );

				}

				const normal = new THREE__namespace.Vector3( 0, 0, 1 ).applyMatrix4( matrix );
				const tangent = new THREE__namespace.Vector3( 1, 0, 0 ).applyMatrix4( matrix );
		...
		_generateUniforms() {
			...
			result.push( {
				diffuseColor: { value: new THREE__namespace.Color() },
				opacity: { value: 1.0 },
			} );
			...
			return THREE__namespace.UniformsUtils.clone( THREE__namespace.UniformsUtils.merge( result ) );
		...
		build( options ) {
			...
			if ( this.isEnable( [ '+DEFERRED_GEOMETRY', '+DEFERRED_LIGHT' ] ) ) {
				...
				this.material = new THREE__namespace.RawShaderMaterial( Object.assign( params, options ) );

				if ( this.isEnable( [ 'GLSL3' ] ) ) {

					this.material.glslVersion = THREE__namespace.GLSL3;
			...
			this.material = new THREE__namespace.ShaderMaterial( Object.assign( params, options ) );
	...
	const ShaderLib = {
		copy: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.copyUniforms ] ),
		...
		id: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.idUniforms ] ),
			vertexShader: ShaderChunk$1.idVert,
			fragmentShader: ShaderChunk$1.idFrag,
		},

		edge: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.edgeUniforms ] ),
			vertexShader: ShaderChunk$1.edgeVert,
			fragmentShader: ShaderChunk$1.edgeFrag,
		},

		edgeExpand: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.edgeExpandUniforms ] ),
			vertexShader: ShaderChunk$1.edgeExpandVert,
			fragmentShader: ShaderChunk$1.edgeExpnadFrag,
		},

		edgeID: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.edgeIDUniforms ] ),
			vertexShader: ShaderChunk$1.edgeIDVert,
			fragmentShader: ShaderChunk$1.edgeIDFrag,
		},

		edgeComposite: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.edgeCompositeUniforms ] ),
			vertexShader: ShaderChunk$1.edgeCompositeVert,
			fragmentShader: ShaderChunk$1.edgeCompositeFrag,
		},

		luminosityHighPass: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.luminosityHighPassUniforms ] ),
			vertexShader: ShaderChunk$1.luminosityHighPassVert,
			fragmentShader: ShaderChunk$1.luminosityHighPassFrag,
		},

		luminosity: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.luminosityUniforms ] ),
			vertexShader: ShaderChunk$1.luminosityVert,
			fragmentShader: ShaderChunk$1.luminosityFrag,
		},

		toneMap: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.toneMapUniforms ] ),
			vertexShader: ShaderChunk$1.toneMapVert,
			fragmentShader: ShaderChunk$1.toneMapFrag,
		},

		ssao: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.ssaoUniforms ] ),
			vertexShader: ShaderChunk$1.ssaoVert,
			fragmentShader: ShaderChunk$1.ssaoFrag,
		},

		ssao2: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.ssao2Uniforms ] ),
			vertexShader: ShaderChunk$1.ssaoVert,
			fragmentShader: ShaderChunk$1.ssao2Frag,
		},

		ssao2Blur: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.ssao2BlurUniforms ] ),
			vertexShader: ShaderChunk$1.copyVert,
			fragmentShader: ShaderChunk$1.ssao2BlurFrag,
		},

		ssao2Composite: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.ssao2CompositeUniforms ] ),
			vertexShader: ShaderChunk$1.copyVert,
			fragmentShader: ShaderChunk$1.ssao2CompositeFrag,
		},

		fxaa: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.antiAliasUniforms ] ),
			vertexShader: ShaderChunk$1.antiAliasVert,
			fragmentShader: ShaderChunk$1.antiAliasFrag,
		},

		colorBalance: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.colorBalanceUniforms ] ),
			vertexShader: ShaderChunk$1.copyVert,
			fragmentShader: ShaderChunk$1.colorBalanceFrag,
		},

		view: {
			uniforms: THREE__namespace.UniformsUtils.merge( [ ShaderChunk$1.viewUniforms ] ),
			vertexShader: ShaderChunk$1.copyVert,
	...
	function createShadowedLight( x, y, z, color, intensity ) {
		...
		const light = new THREE__namespace.DirectionalLight( color, intensity );
		const d = 1;
	...
	const OceanShader = {
		uniforms: {
			...
			sunColor: { value: new THREE__namespace.Color( 0x7f7f7f ) },
			sunDirection: { value: new THREE__namespace.Vector3( 0.70707, 0x70707, 0 ) },
			eye: { value: new THREE__namespace.Vector3() },
			waterColor: { value: new THREE__namespace.Color( 0x555555 ) },
			textureMatrix: { value: new THREE__namespace.Matrix4() },
		},
		...
		fragmentShader: [
			...
			THREE__namespace.ShaderChunk[ 'common' ],
			THREE__namespace.ShaderChunk[ 'fog_pars_fragment' ],
			...
			THREE__namespace.ShaderChunk[ 'fog_fragment' ],
			'  gl_FragColor = vec4(outgoingLight, alpha);',
			THREE__namespace.ShaderChunk[ 'tonemapping_fragment' ],
			'}',
		].join( '\n' ),
	};

	class Ocean extends THREE__namespace.Object3D {
		...
		constructor( renderer, camera, scene, options ) {
			...
			this.sunDirection = optionalParameter( options.sunDirection, new THREE__namespace.Vector3( 0.70707, 0.70707, 0.0 ) );
			this.sunColor = new THREE__namespace.Color( optionalParameter( options.sunColor, 0xffffff ) );
			this.waterColor = new THREE__namespace.Color( optionalParameter( options.waterColor, 0x7f7f7f ) );
			this.eye = optionalParameter( options.eye, new THREE__namespace.Vector3( 0, 0, 0 ) );
			this.distortionScale = optionalParameter( options.distortionScale, 20.0 );
			this.reflectionScale = optionalParameter( options.reflectionScale, 0.01 );
			this.side = optionalParameter( options.side, THREE__namespace.FrontSide );
			this.fog = optionalParameter( options.fog, false );
			this.envSampler = optionalParameter( options.envMap, null );

			this.renderer = renderer;
			this.scene = scene;
			this.mirrorPlane = new THREE__namespace.Plane();
			this.normal = new THREE__namespace.Vector3( 0, 0, 1 );
			this.mirrorWorldPosition = new THREE__namespace.Vector3();
			this.cameraWorldPosition = new THREE__namespace.Vector3();
			this.rotationMatrix = new THREE__namespace.Matrix4();
			this.lookAtPosition = new THREE__namespace.Vector3( 0, 0, -1 );
			this.clipPlane = new THREE__namespace.Vector4();
			...
			this.renderTarget = new THREE__namespace.WebGLRenderTarget( width, height );
			// this.renderTarget2 = new THREE.WebGLRenderTarget(width, height);

			const mirrorShader = OceanShader;
			const mirrorUniforms = THREE__namespace.UniformsUtils.clone( mirrorShader.uniforms );
			...
			if ( !THREE__namespace.MathUtils.isPowerOfTwo( width ) || !THREE__namespace.MathUtils.isPowerOfTwo( height ) ) {

				this.renderTarget.texture.generateMipmaps = false;
				this.renderTarget.texture.minFilter = THREE__namespace.LinearFilter;
		...
		updateTextureMatrix() {
			...
			const q = new THREE__namespace.Vector4();
			...
			let c = new THREE__namespace.Vector4();
			...
			const worldCoordinate = new THREE__namespace.Vector3();
		...
		render() {
			...
			if ( scene !== undefined && scene instanceof THREE__namespace.Scene ) {
	 ...
	 */
	class ShadowMesh extends THREE__namespace.Mesh {

		constructor( mesh, materialOption ) {

			const shadowMaterial = new THREE__namespace.MeshBasicMaterial(
				Object.assign(
					{
						color: 0x000000,
						transparent: true,
	...
	const GPUParticleShader = {
		uniforms: {
			...
			viewSize: { value: new THREE__namespace.Vector2( window.innerWidth, window.innerHeight ) },
			tDepth: { value: null },
			cameraNearFar: { value: new THREE__namespace.Vector2( 1, 100 ) },
		},
	...
	class GPUParticle extends THREE__namespace.Points {
		...
		constructor( numParticles, initCallback ) {
			...
			const pars = {
				...
				acceleration: new THREE__namespace.Vector3(),
				spinStart: 0,
				spinSpeed: 0,
				startSize: 1,
				endSize: 1,
			...
			geo.setAttribute( 'velocitySpinStart', new THREE__namespace.BufferAttribute( velocitySpinStartArray, 4 ) );
			geo.setAttribute( 'accelerationSpinSpeed', new THREE__namespace.BufferAttribute( accelerationSpinSpeedArray, 4 ) );
			geo.setAttribute(
				'startSizeEndSizeStartTimeLifeTime',
				new THREE__namespace.BufferAttribute( startSizeEndSizeStartTimeLifeTimeArray, 4 )
			);

			const material = new THREE__namespace.RawShaderMaterial( {
				uniforms: THREE__namespace.UniformsUtils.clone( GPUParticleShader.uniforms ),
	...
	class HeightField {
		...
		generate( img, scale ) {
			...
			const geo = new THREE__namespace.PlaneGeometry( img.width, img.height, img.width - 1, img.height - 1 );
		...
		generateHeight( params ) {
			...
			const geo = new THREE__namespace.PlaneGeometry( this.widthExtents, this.depthExtents, this.width - 1, this.depth - 1 );
			geo.rotateX( -Math.PI / 2 );
			const vertices = geo.attributes.position.array;
	...
	class ScreenSprite {
		...
		constructor( material, canvas ) {
			...
			this.camera = new THREE__namespace.OrthographicCamera( -this.sw / 2, this.sw / 2, this.sh / 2, -this.sh / 2, 1, 10 );
			this.camera.position.set( 0, 0, 2 );
			this.scene = new THREE__namespace.Scene();
			const plane = new THREE__namespace.PlaneGeometry( frame.width, frame.height );
			const mesh = new THREE__namespace.Mesh( plane, material );
			this.scene.add( mesh );
	...
	class ShaderPass extends Pass {
		...
		constructor( shader, textureID ) {
			...
			if ( shader instanceof THREE__namespace.ShaderMaterial ) {
				...
				this.uniforms = THREE__namespace.UniformsUtils.clone( shader.uniforms );
				this.material = new THREE__namespace.ShaderMaterial( {
			...
			this.scene = new THREE__namespace.Scene();
			this.quad = new THREE__namespace.Mesh( new THREE__namespace.PlaneGeometry( 2, 2 ), null );
	...
	class EdgePass extends ScreenPass {
		...
		constructor( aspect, strength, color, idedge, resolution ) {
			...
			this.edgeBuffer = new THREE__namespace.WebGLRenderTarget( resolution, resolution, pars );
			this.edgeExpandBuffer = new THREE__namespace.WebGLRenderTarget( resolution, resolution, pars );

			const edgeShader = ShaderLib.edge;
			this.edgeUniforms = THREE__namespace.UniformsUtils.clone( edgeShader.uniforms );
			this.edgeMaterial = new THREE__namespace.ShaderMaterial( {
			...
			this.edgeExpandUniforms = THREE__namespace.UniformsUtils.clone( edgeExpandShader.uniforms );
			this.edgeExpandMaterial = new THREE__namespace.ShaderMaterial( {
			...
			this.idUniforms = THREE__namespace.UniformsUtils.clone( edgeIDShader.uniforms );
			this.idMaterial = new THREE__namespace.ShaderMaterial( {
			...
			this.compositeUniforms = THREE__namespace.UniformsUtils.clone( compositeShader.uniforms );
			this.compositeMaterial = new THREE__namespace.ShaderMaterial( {
	...
	class SSAARenderPass extends Pass {
		...
		constructor( scene, camera, clearColor, clearAlpha ) {
			...
			this.copyMaterial = new THREE__namespace.ShaderMaterial( {
			...
			this.camera2 = new THREE__namespace.OrthographicCamera( -1, 1, 1, -1, 0, 1 );
			this.scene2 = new THREE__namespace.Scene();
			this.quad2 = new THREE__namespace.Mesh( new THREE__namespace.PlaneGeometry( 2, 2 ), this.copyMaterial );
		...
		render( renderer, writeBuffer, readBuffer, _delta, _maskActive ) {
			...
			if ( !this.sampleRenderTarget ) {
				...
				this.sampleRenderTarget = new THREE__namespace.WebGLRenderTarget( readBuffer.width, readBuffer.height, {
					minFilter: THREE__namespace.LinearFilter,
					magFilter: THREE__namespace.LinearFilter,
			...
			const oldRenderTarget = renderer.getRenderTarget();
			const oldClearColor = new THREE__namespace.Color();
			renderer.getClearColor( oldClearColor );
	...
	class TAARenderPass extends SSAARenderPass {
		...
		render( renderer, writeBuffer, readBuffer, delta ) {
			...
			if ( !this.sampleRenderTarget ) {
				...
				this.sampleRenderTarget = new THREE__namespace.WebGLRenderTarget( readBuffer.width, readBuffer.eheight, this.params );

			}

			if ( !this.holdRenderTarget ) {

				this.holdRenderTarget = new THREE__namespace.WebGLRenderTarget( readBuffer.width, readBuffer.eheight, this.params );
	...
	class UnrealBloomPass extends ScreenPass {
		...
		constructor( resolution, strength, radius, threshold, hdr ) {
			...
			this.resolution =
				resolution !== undefined ? new THREE__namespace.Vector2( resolution.x, resolution.y ) : new THREE__namespace.Vector2( 256, 256 );
			...
			if ( hdr ) {
				...
				pars.type = THREE__namespace.FloatType;
			...
			this.rtBright = new THREE__namespace.WebGLRenderTarget( resx, resy, pars );
			this.rtBright.texture.generateMipmaps = false;

			for ( let i = 0; i < this.nMips; i++ ) {

				let rt = new THREE__namespace.WebGLRenderTarget( resx, resy, pars );
				rt.texture.generateMipmaps = false;
				this.rtHori.push( rt );

				rt = new THREE__namespace.WebGLRenderTarget( resx, resy, pars );
				rt.texture.generateMipmaps = false;
				this.rtVert.push( rt );
			...
			this.highPassUniforms = THREE__namespace.UniformsUtils.clone( shader.uniforms );
			this.highPassUniforms.luminosityThreshold.value = this.threshold;
			this.highPassUniforms.smoothWidth.value = 0.01;

			this.highPassMaterial = new THREE__namespace.ShaderMaterial( {
			...
			for ( let i = 0; i < this.nMips; i++ ) {
				...
				this.separableBlurMaterials[ i ].uniforms.texSize.value = new THREE__namespace.Vector2( resx, resy );
			...
			this.enabled = true;
			this.needsSwap = false;
			this.oldClearColor = new THREE__namespace.Color();
		...
		render( renderer, writeBuffer, readBuffer, delta, maskActive ) {
			...
			const oldAutoClear = renderer.autoClear;
			renderer.autoClear = false;
			renderer.setClearColor( new THREE__namespace.Color( 0, 0, 0 ), 0 );
	...
	UnrealBloomPass.BlurDirectionX = new THREE__namespace.Vector2( 1.0, 0.0 );
	UnrealBloomPass.BlurDirectionY = new THREE__namespace.Vector2( 0.0, 1.0 );
	...
	class SSAOPass extends ScreenPass {
		...
		constructor( parameters ) {
			...
			this.resolution = parameters.resolution || new THREE__namespace.Vector2( 512, 512 );
			...
			this.rtBlur1 = new THREE__namespace.WebGLRenderTarget(
				this.resolution.x / this.downsampling,
				this.resolution.y / this.downsampling,
				pars
			);
			this.rtBlur2 = new THREE__namespace.WebGLRenderTarget(
				this.resolution.x / this.downsampling,
				this.resolution.y / this.downsampling,
				pars
			);

			this.makeUniforms = THREE__namespace.UniformsUtils.clone( ShaderLib.ssao2.uniforms );
			this.makeMaterial = new THREE__namespace.ShaderMaterial( {
			...
			this.blurXUniforms = THREE__namespace.UniformsUtils.clone( ShaderLib.ssao2Blur.uniforms );
			this.blurXMaterial = new THREE__namespace.ShaderMaterial( {
			...
			this.blurYUniforms = THREE__namespace.UniformsUtils.clone( ShaderLib.ssao2Blur.uniforms );
			this.blurYMaterial = new THREE__namespace.ShaderMaterial( {
			...
			this.compositeUniforms = THREE__namespace.UniformsUtils.clone( ShaderLib.ssao2Composite.uniforms );
			this.compositeMaterial = new THREE__namespace.ShaderMaterial( {
				uniforms: this.compositeUniforms,
			...
			this.viewUniforms = THREE__namespace.UniformsUtils.clone( ShaderLib.view.uniforms );
			this.viewMaterial = new THREE__namespace.ShaderMaterial( {
	...
	const colorBalanceUniforms = {
		...
		cColorBalanceShadows: { value: new THREE__namespace.Vector3( 0.0, 0.0, 0.0 ) },
		cColorBalanceMidtones: { value: new THREE__namespace.Vector3( 0.0, 0.0, 0.0 ) },
		cColorBalanceHighlights: { value: new THREE__namespace.Vector3( 0.0, 0.0, 0.0 ) },
	...
	const coneUniforms = {
		cDirection: { value: new THREE__namespace.Vector2( 0.0, 1.0 ) },
		cPowerExponent: { value: 1.0 },
	};
	...
	class FxgenShader {
		...
		generateUniforms() {
			...
			uniforms.push( {
				resolution: { value: new THREE__namespace.Vector2() },
				mouse: { value: new THREE__namespace.Vector2() },
				time: { value: 0.0 },
				cameraPos: { value: new THREE__namespace.Vector3() },
				cameraDir: { value: new THREE__namespace.Vector3() },
				tDiffuse: { value: null },
			} );
			...
			return THREE__namespace.UniformsUtils.clone( THREE__namespace.UniformsUtils.merge( uniforms ) );
		...
		createMaterial( uniforms ) {
			...
			if ( this.check( [ 'GLSL3' ] ) ) {
				...
				material.glslVersion = THREE__namespace.GLSL3;
	...
	const FxgenShaderUtils = {
		...
		SetShaderParameter( uniforms, key, value ) {
			...
			if ( key in uniforms ) {
				...
				if ( uniforms[ key ].value instanceof THREE__namespace.Color ) {
					...
					if ( value instanceof THREE__namespace.Color ) {
						...
						uniforms[ key ].value.copy( new THREE__namespace.Color( value ) );

					}

				} else if (
					uniforms[ key ].value instanceof THREE__namespace.Color ||
					uniforms[ key ].value instanceof THREE__namespace.Vector2 ||
					uniforms[ key ].value instanceof THREE__namespace.Vector3 ||
					uniforms[ key ].value instanceof THREE__namespace.Vector4 ||
					uniforms[ key ].value instanceof THREE__namespace.Matrix3 ||
					uniforms[ key ].value instanceof THREE__namespace.Matrix4
				) {

					uniforms[ key ].value.copy( value );

				} else if ( uniforms[ key ].value instanceof THREE__namespace.CubeTexture || uniforms[ key ].value instanceof THREE__namespace.Texture ) {
		...
		SetShaderArrayParameter( uniforms, arrayKey, index, key, value ) {
			...
			if ( arrayKey in uniforms ) {
				...
				if ( key in uniforms[ arrayKey ].value[ index ] ) {
					...
					if (
						uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Color ||
						uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Vector2 ||
						uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Vector3 ||
						uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Vector4 ||
						uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Matrix3 ||
						uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Matrix4
					) {

						uniforms[ arrayKey ].value[ index ][ key ].copy( value );

					} else if (
						uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.CubeTexture ||
						uniforms[ arrayKey ].value[ index ][ key ] instanceof THREE__namespace.Texture
					) {
	...
	exports.FxgenShader = FxgenShader;
	exports.FxgenShaderUtils = FxgenShaderUtils;
