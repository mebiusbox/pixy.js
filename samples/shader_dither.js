...
const app = {
	...
	initScene() {
		...
		var plane = new THREE.Mesh( planeGeometry, this.ditherShader.material );
	...
	initGui() {
		...
		const context = this;
		h.add( this.parameters, 'ditherOpacity', 0.0, 1.0, 0.001 ).onChange( function ( value ) {

			context.ditherShader.uniforms.opacity.value = value;
